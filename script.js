...
function initNavigation() {
    ...
    window.addEventListener('scroll', () => {
        if (window.scrollY > 50) {
            navbar.style.backgroundColor = 'rgba(253, 252, 246, 0.98)';
            navbar.style.boxShadow = '0 2px 20px rgba(160, 64, 40, 0.1)';
        } else {
            navbar.style.backgroundColor = 'rgba(253, 252, 246, 0.95)';
...
function initContactForm() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', (e) => {
            ...
            submitBtn.innerHTML = '<i data-lucide="loader" class="btn-icon animate-spin"></i> Enviando...';
...
window.downloadCV = function() {
    // Create a simple CV summary without company names
    const cvContent = `
LIZBETH AVENA HERNÁNDEZ
MSc Ciencias de la Tierra | Geóloga Profesional
Contacto: +1 (510) 421-1524 | lizbeth.avenita@gmail.com

PERFIL PROFESIONAL
Geóloga bilingüe y especialista ambiental con más de 7 años de amplia experiencia de campo en Estados Unidos y México. Expertise comprobada en wellsite geology, mudlogging, compliance ambiental y remediación de sitios.

FORMACIÓN ACADÉMICA
• Master en Ciencias de la Tierra
  Universidad Nacional Autónoma de México
  Geoquímica y Petrología del complejo gabróico de Manzanillo, Colima
  
• Ingeniería en Minas y Metalurgia
  Universidad Autónoma de Chihuahua
  Licencia Profesional MX

EXPERIENCIA PROFESIONAL

Especialista en Transferencia de Agua y Ambiental (Oct 2023 - Dic 2023)
• Inspecciones ambientales en sitios de fracturación
• Medición y transferencia de calidad de agua
• Operación de bombas centrífugas y sumergibles

Geóloga de Campo - Servicios Ambientales (Oct 2022 - Oct 2023)
• Supervisión de operaciones de perforación y logging
• Muestreo de agua, suelo y vapor
• Mantenimiento de equipos PID y estaciones de vacío

Operador MWD/Mudlogger - Geóloga de Pozos (2008 - 2021)
• Gestión de unidades de mudlogging en Permian Basin
• Logging de formaciones Bone Spring y Wolfcamp
• Operación de software especializado

Auditor Técnico Experto - Certificaciones (Jun 2020 - Actual)
• Experto Técnico en Química (recalificado julio 2020)
• Auditorías ISO 9001 e ISO 17025

CERTIFICACIONES DE SEGURIDAD
• HAZWOPER 40 horas (Vigente 2023)
• OSHA 30 horas
• Safeland (Vigente 2024)
• CSX Roadway Worker Protection (Vigente 2025-2026)
• DOT Physical Certificate (Expira 01/26)

SOFTWARE Y HERRAMIENTAS
• ArcGIS, QGIS, AutoCAD, Global Mapper
• Kingdom Suite, Mainlog, Zone Vu, TLog

COMPETENCIAS TÉCNICAS
• Mapeo de minas a cielo abierto y subterráneas
• Muestreo de suelos y control de calidad
• Geoesteering y mudlogging
• Análisis XRF y modelado geoquímico
...
Proyectos de recolección de datos para compañías mineras en diferentes proyectos de México y Estados Unidos, incluyendo proyectos en Arizona, Nevada, Oregon y múltiples estados mexicanos.
    `;
    ...
    a.href = url;
    a.download = 'CV_Lizbeth_Avena_Hernandez.txt';
