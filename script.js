...
function initNavigation() {
    ...
    navLinks.forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            // Check if this is an internal link (same page with #section)
            if (href.startsWith('#')) {
                // Internal navigation - prevent default and smooth scroll
                e.preventDefault();
                ...
                // External navigation (like from gallery to index) - allow normal navigation
